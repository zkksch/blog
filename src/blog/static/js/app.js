...
/***/ "./src/core/redux/actions/base.ts":
/*!****************************************!*\
  !*** ./src/core/redux/actions/base.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
function createAsyncAction(before, result, error, coroutine, args) {
    var _this = this;
    return function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, coroutine.apply(void 0, __spread([getState()], args))];
                    case 1:
                        resultData = _a.sent();
                        return [2 /*return*/, dispatch(result(resultData, getState()))];
                    case 2:
                        e_1 = _a.sent();
                        return [2 /*return*/, dispatch(error(e_1, getState()))];
...
var base_1 = __webpack_require__(/*! core/redux/actions/base */ "./src/core/redux/actions/base.ts");
exports.loadingPosts = function () { return typesafe_actions_1.action(actionType.SET_POST_REQUEST); };
exports.setPosts = function (posts) { return typesafe_actions_1.action(actionType.SET_POST_SUCCESS, posts); };
exports.setPostsErr = function () { return typesafe_actions_1.action(actionType.SET_POST_FAILURE); };
exports.requestPosts = base_1.createAsyncAction(exports.loadingPosts, exports.setPosts, exports.setPostsErr, function () { return __awaiter(_this, void 0, void 0, function () {
    var response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch('/post/')];
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.json()];
            case 2:
                data = _a.sent();
                return [2 /*return*/, data.map(function (el) { return el.title; })];
        }
    });
}); }, []);
